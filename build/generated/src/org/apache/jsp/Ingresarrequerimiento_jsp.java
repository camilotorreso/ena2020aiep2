...
public final class Ingresarrequerimiento_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String formato=(String) request.getAttribute("vacio1"); 
      ...
      out.write("        <link href=\"css/estiloIngRq.css\" rel=\"stylesheet\" type=\"text/css\"/>\n");
...
i=i+1;}
      ...
      out.write("            function recargarlista1(){\n");
...
for(int e=0;e<i;e++){
      ...
      out.write("            \n");
      out.write("            </script>\n");
      out.write("            <!mismo codigo diferentes campos>\n");
      out.write("        <script>\n");
      out.write("            //$(document).ready(function() permite que cargue la pagina antes de usar las funciones\n");
      out.write("\t    $(document).ready(function(){\n");
      out.write("            $('#listam').change(function(){\n");
      out.write("            $(\"#lista2\").empty();\n");
      out.write("            recargarlista();\n");
      out.write("            });\n");
      out.write("            });\n");
      out.write("            var departamentom=[];\n");
      out.write("            ");
try{ 
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/requerimientos?zeroDateTimeBehavior=convertToNull","root","");
            ...
            while(rs.next()){
      out.write("\n");
      out.write("            departamentom[departamentom.length]=\"");
      out.print(rs.getString("departamento"));
      out.write("\";\n");
      out.write("            var encargados");
      out.print(i);
      out.write("=[];\n");
      out.write("            ");
i=i+1;}
      ...
      out.write("\n");
      out.write("            \n");
      out.write("                if(departamentom[");
      out.print(e);
      out.write("]===\"");
      out.print(rs.getString("departamento"));
      out.write("\"){\n");
      out.write("                encargados");
      out.print(e);
      out.write("[encargados");
      out.print(e);
      out.write(".length]=\"");
      ...
      out.write("                $(\"#lista2\").append(\"<option value=\\\"1\\\" label=\\\"Seleccione\\\"></option>\");\n");
      out.write("            ");
for(int e=0;e<i;e++){
      out.write("\n");
      out.write("                       if(departamentom[");
      out.print(e);
      out.write("]===$(\"#listam\").val()){\n");
      out.write("                           for(i=0;i<encargados");
      out.print(e);
      out.write(".length;i++){\n");
      out.write("            $(\"#lista2\").append(\"<option value='\"+encargados");
      out.print(e);
      out.write("[i]+\"'>\"+encargados");
      out.print(e);
      out.write("[i]+\"</option>\");\n");
      out.write("            };};\n");
      out.write("            ");
      ...
      out.write("        <h1 class=\"p\">Ingresar Requerimiento</h1>\n");
      out.write("        <hr>\n");
      out.write("        <form action=\"controlador\" method=\"POST\">\n");
      out.write("          \n");
      out.write("     <table>\n");
      out.write("                    <!datos cargados de la base de datos gerentes >\n");
      out.write("                <tr>\n");
      ...
      out.write("                \n");
      out.write("                    <!este select de departamentos de gerentes se recargara a travez de la funcion de javascript,jquery antes descrita>\n");
      out.write("                <tr>\n");
      ...
      out.write("                <tr><td><br></td><td></td></tr>\n");
      out.write("                    \n");
      out.write("                <!datos cargados de la bdd de departamentos de mantencion >\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"p\">Asignado a</td><td><select class=\"btn\" id=\"listam\" style=\"width:200px\" name=\"departamentosm\">\n");
      out.write("                    <option value=\"1\" label=\"Escoge una opcion\"></option>\n");
      out.write("                    ");
      ...
      out.write("                <tr><td><br></td><td></td></tr>\n");
      out.write("                  \n");
      out.write("                <!este select se cargara con las funciones anteriores de js,jq >\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"p\">Encargado</td><td><select class=\"btn\" id=\"lista2\" style=\"width:200px;\" name=\"encargados\">\n");
      out.write("                    <option value=\"1\" label=\"Escoge una opcion\"></option>\n");
      out.write("                    </select></td>\n");
      out.write("                </tr>\n");
      out.write("                    \n");
      out.write("                <tr><td><br></td><td></td></tr>\n");
      out.write("                    \n");
      out.write("                <!campo requerimiento>\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"p\">Requerimiento :</td><td><input class=\"p\" type='text' name='descripcion' style=\"width:400px;height:100px\"></td>\n");
      out.write("                </tr>\n");
      out.write("                    \n");
      out.write("                    <tr>\n");
      out.write("                        <td><input class=\"btn\" type='submit' value=\"Guardar\" name=\"guardar\"></td><td></td>\n");
      out.write("                    </tr>\n");
      out.write("                    \n");
      out.write("                    <tr><!identificador de pagina>\n");
      out.write("                        <td><input type='hidden' name=\"acto\" value=\"2\"></td><td></td>\n");
      out.write("                    </tr>\n");
      out.write("            </table>\n");
      out.write("                    \n");
      out.write("        </form>\n");
      out.write("       \n");
      out.write("        <!consulta si hay mensaje para mostrar>\n");
      out.write("        ");
if(formato!=null){
      out.write("\n");
